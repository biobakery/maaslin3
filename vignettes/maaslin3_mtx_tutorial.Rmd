...
* [3. Running the MTX model](#3-running-the-mtx-model)
    ...
    * [3.3.1 Raw RNA Abundances with MaAsLin
    3](#331-raw-rna-abundances-with-maaslin-3)
    * [3.3.2 RNA/DNA Ratios with MaAsLin
    3](#332-rna-dna-ratios-with-maaslin-3)
    * [3.3.3 RNA abundance adjusted by DNA abundance with MaAsLin
    3](#333-rna-abundance-adjusted-by-dna-abundance-with-mtxmodel)
...
{#331-raw-rna-abundances-with-maaslin-3}
...
{#332-rna-dna-ratios-with-maaslin-3}
...
{#333-rna-abundance-adjusted-by-dna-abundance-with-mtxmodel}
...
```{r, fig.width=8, fig.height=4, fig.align='center', cache=TRUE,
include=FALSE}
...
results$model <- ifelse(results$model == 'LM', 'Abundance',
'Prevalence')
