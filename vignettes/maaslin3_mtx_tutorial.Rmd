...
intersect(results_rna_ratio$feature, results_rna$feature) # 19 features overlapped
...
intersect(results_rna_ratio$feature, results_rna_dna$feature) # 18 features overlapped
```
...
```{r, fig.width=8, fig.height=4, fig.align='center', cache=TRUE, include=FALSE}
