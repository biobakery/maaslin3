...
### Support ###
The user manual can be found [here](https://github.com/biobakery/Maaslin3). If you have questions, please direct them to the [MaAsLin 3 Forum](https://forum.biobakery.org/c/Downstream-analysis-and-statistics/MaAsLin3)   . 
...
threshold, ordered by increasing joint q-value. The format is:
  ...
  * `pval_individual` and `qval_individual` are the p-value and false discovery rate (FDR) corrected q-value of the individual association.
