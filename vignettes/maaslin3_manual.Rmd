...
* Enable parallelization by creating background 
[daemons](https://mirai.r-lib.org/reference/daemons.html) using 
[mirai](https://mirai.r-lib.org/articles/mirai.html) e.g. call 
`mirai::daemons(2)` before running `maaslin3()` to use two cores.
